		...
		<Dialog open={open} onOpenChange={handleOpenChange}>
			...
			>
				<DialogHeader className="border-b px-6 py-5 pr-14">
					...
					<DialogDescription>Select available schedule slots from today onwards.</DialogDescription>
				</DialogHeader>

				<ScrollArea className="max-h-[calc(90vh-5.5rem)]">
					<div className="space-y-4 px-6 py-5">
						{(isLoadingSchedules || isLoadingMySchedules) && (
							<div className="rounded-md border p-4 text-sm text-muted-foreground">Loading available schedules...</div>
						)}
									...
									return (
										...
										>
											...
											<div className="space-y-1">
												...
												<p className="text-muted-foreground">Ends at {formatDateTime(schedule.endDateTime)}</p>
											</div>
										</label>
									);
								})}
