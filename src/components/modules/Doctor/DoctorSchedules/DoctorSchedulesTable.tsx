...
const DOCTOR_SCHEDULE_FILTER_DEFINITIONS = [serverManagedFilter.single("isBooked")];
...
const DoctorSchedulesTable = ({ initialQueryString }: { initialQueryString: string }) => {
	...
	return (
		<>
			...
			<ViewMyScheduleDialog open={isViewDialogOpen} onOpenChange={onViewOpenChange} doctorSchedule={viewingItem} />
		</>
	);
};
