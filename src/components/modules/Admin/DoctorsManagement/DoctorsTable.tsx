	...
	return (
		<>
			<DataTable
				...
				toolbarAction={<CreateDoctorFormModal specialties={specialties} isLoadingSpecialties={isLoadingSpecialties} />}
				meta={meta}
			...
			<ViewDoctorProfileDialog open={isViewDialogOpen} onOpenChange={onViewOpenChange} doctor={viewingItem} />
		</>
	);
};
