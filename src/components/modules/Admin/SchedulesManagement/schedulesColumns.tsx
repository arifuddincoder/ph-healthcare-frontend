...
export const schedulesColumns: ColumnDef<ISchedule>[] = [
	{
		...
		header: "Start",
		cell: ({ row }) => <DateCell date={row.original.startDateTime} formatString="MMM dd, yyyy hh:mm a" />,
	},
	{
		id: "endDateTime",
		accessorKey: "endDateTime",
		header: "End",
		cell: ({ row }) => <DateCell date={row.original.endDateTime} formatString="MMM dd, yyyy hh:mm a" />,
	},
	{
		id: "duration",
		header: "Duration",
