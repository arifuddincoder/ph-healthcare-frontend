...
const SchedulesTable = ({ initialQueryString }: { initialQueryString: string }) => {
	...
	return (
		<>
			...
			<EditScheduleFormModal open={isEditModalOpen} onOpenChange={onEditOpenChange} schedule={editingItem} />
			...
			<ViewScheduleDialog open={isViewDialogOpen} onOpenChange={onViewOpenChange} schedule={viewingItem} />
		</>
	);
};
