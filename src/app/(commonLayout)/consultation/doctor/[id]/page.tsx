import BookAppointmentModal from "@/components/modules/Patient/BookAppointmentModal";
			...
			<div className="grid gap-4 md:grid-cols-2">
				<div className="rounded-2xl border bg-card p-5 shadow-sm">
					...
					<div className="space-y-2 text-sm">
						...
						<p>
							<span className="font-medium">Registration Number:</span> {doctorDetails.registrationNumber || "N/A"}
						</p>
						<p>
							<span className="font-medium">Appointment Fee:</span> ${doctorDetails.appointmentFee?.toFixed(2) ?? "N/A"}
						</p>
						<p>
							<span className="font-medium">Average Rating:</span> {doctorDetails.averageRating?.toFixed(1) ?? "0.0"}
						</p>
					</div>
				</div>
				...
				<div className="rounded-2xl border bg-card p-5 shadow-sm">
					...
					<div className="space-y-2 text-sm">
						...
						<p>
							<span className="font-medium">Contact Number:</span> {doctorDetails.contactNumber || "N/A"}
						</p>
						<p>
				...
				<div className="space-y-3">
					{(doctorDetails.reviews ?? []).map((review, index) => (
						<div key={review.id ?? `review-${index}`} className="rounded-md border p-3 text-sm">
							...
							<p>
								<span className="font-medium">Patient ID:</span> {review.patientId || "N/A"}
							</p>
