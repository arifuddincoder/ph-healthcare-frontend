			...
			<div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
				...
				<Card>
					<CardHeader>
						...
						<CardDescription>
							Choose whether to pay now at checkout or keep the appointment unpaid for later.
						</CardDescription>
					</CardHeader>
					...
					<CardContent className="space-y-4">
						...
						<Alert>
							...
							<AlertDescription>
								Pay now opens Stripe checkout. Pay later keeps the booking in your appointments list so you can complete
								payment later.
							</AlertDescription>
						</Alert>
					</CardContent>
