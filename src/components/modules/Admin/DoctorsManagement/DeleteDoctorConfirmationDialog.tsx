...
const DeleteDoctorConfirmationDialog = ({ open, onOpenChange, doctor }: DeleteDoctorConfirmationDialogProps) => {
		...
		<AlertDialog open={open} onOpenChange={onOpenChange}>
			<AlertDialogContent>
				<AlertDialogHeader>
					...
					<AlertDialogDescription>
						Are you sure you want to delete {doctor?.name ?? "this doctor"}? This action will mark the doctor and linked
						user as deleted.
					</AlertDialogDescription>
				</AlertDialogHeader>
